...
<head>
    ...
    <!-- AdminLTE CSS -->
    <link rel="stylesheet" href="<?= base_url('application/adminlte/src/html/public/css/adminlte.min.css') ?>">
    <style>
        body {
        ...
        <div class="card">
            <div class="card-header">
                <div class="login-logo">
                    <i class="bi bi-phone"></i> Admin
                </div>
                <p class="text-muted">Sign in to your admin panel</p>
            </div>
            <div class="card-body">
